...
namespace Not_Kayit_Sistemi
{
    public partial class FrmOgretmenDetay : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=ERK009\SQLEXPRESS;Initial Catalog=DbNotKayit;Integrated Security=True");
        ...
        private void FrmOgretmenDetay_Load(object sender, EventArgs e)
        {
            ...
            //LblOrtalama.Text = dbNotKayitDataSet.TBLDERS.Sum(y => y.ORTALAMA / (Convert.ToInt32(LblGecenSayisi.Text) + Convert.ToInt32(LblKalanSayisi.Text))).ToString();
        }
